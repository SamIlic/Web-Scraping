...
class CMCRolling(scrapy.Spider):
    name = 'CMCRolling'  # Name of Script
...
################################################################################################
    ...
    def closed( self, reason ):
        ...
        # Write Sheet
        Rolling_df.to_excel(writer_HardDrive, startrow= 0 , index=True, sheet_name= 'Rolling' + timeStamp) # write to "MASTER-Ercot.xlsx" spreadsheet
